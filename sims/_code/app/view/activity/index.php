                ...
                <table class="list_table" width="100%" cellpadding="0" cellspacing="0">
                    ...
                    foreach ($list as $i => $row) {
                        ...
                        <tr>
                            ...
                            <td><?php echo stripslashes(str_replace($activityname, '<font color=red>' . $activityname . '</font>', $row['activityname'])); ?></td>
                            <td><?php echo stripslashes(str_replace($actadmin, '<font color=red>' . $actadmin . '</font>', $row['actadmin'])); ?></td>
                            <td><?php echo stripslashes(str_replace($detail, '<font color=red>' . $detail . '</font>', $row['detail'])); ?></td>
