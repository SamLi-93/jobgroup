...
<form class="fsimple" id="form_news" name="form_news" action="" method="post" enctype="multipart/form-data" >
    <table class="table table-striped table-bordered bootstrap-datatable datatable">
      <tr height="30">
        <td width="146" >微信名：</td>
        <td width="842" ><input name="nickname" type="text"  id="nickname" value="" size="50" /><font class="req">*</font></td>
      </tr>
      <tr height="30">
        <td >身份号：</td>
        <td width="842" ><input name="openid" type="text"  id="openid" value="" size="50" /><font class="req">*</font></td>
      </tr>
      ...
      <td ></td>
        <td>
          ...
          <div class="btn4 mr20" onclick="javascript:location='<?php echo url('jackpot')?>';">返回</div></td>
      </tr>
    </table>
</form>       
</div>      
