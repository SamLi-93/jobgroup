...
/**
 * Jackpot 封装来自 zhongjiang 数据表的记录及领域逻辑
 */
class Jackpot extends QDB_ActiveRecord_Abstract
{
    ...
    static function __define()
    {
        ...
        (
            ...
            (
                'openid' => array
                (
                    array('not_empty', 'openid不能为空'),
                    array('max_length', 128, 'openid不能超过 128 个字符'),

                ),

                'nickname' => array
                (
                    array('max_length', 128, 'nickname不能超过 128 个字符'),

                ),

                'headimg' => array
                (
                    array('max_length', 255, 'headimg不能超过 255 个字符'),

                ),

                'grade' => array
                (
                    array('is_int', '类别必须是一个整数'),

                ),

                'activity_id' => array
                (
                    array('is_int', 'activity_id必须是一个整数'),
